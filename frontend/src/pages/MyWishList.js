...
// PROBLÈME DE CSS les cards devraient rester toutes de la meme grosseur malgre les formats d'images differents
// CETTE PAGE CONTIENT DES DONNEES HARDCODEES QUI DOIVENT ETRE REMPLACEES
// incapable de faire ouvrir le lien cliqué dans un NOUVEL ONGLET
                ...
                <div className="row row-cols-1 row-cols-md-3 g-4">
                    <div className="col">
                        <div className="card h-500">
                            <img src={ImageSouliers} className="card-img-top" alt="..." height="400" width="300"/>
