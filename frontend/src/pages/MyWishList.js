    ...
    return (
        <div style={fullBackgroundStyle}>
            <div className='container-fluid text-center'>
                <div className="pt-3">
                    <h2 className="title-piges" style={{color: '#FF3991'}}>Voici la liste de suggestions de cadeaux de {userPige.user.userFirstName}, pour la pige
                         {userPige.pige.pigeName}
