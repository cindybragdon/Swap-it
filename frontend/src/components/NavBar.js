...
const NavBar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-sm navbar-dark p-2 fixed-top mb-0" style={{fontFamily: "Reddit Mono"}}>
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="n_bar">
                    <ul className="navbar-nav  ">
                        ...
                        <li className="nav-item"><a className="nav-link" href="/inv">Mes invitations {countInv > 0 ?
